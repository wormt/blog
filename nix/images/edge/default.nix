    ...
    layeredImage = {
      ...
      fromImage =
        (pkgs.dockerTools.pullImage {
          ...
          imageDigest = "sha256:50cfd3eb8ef8cc8e6d020aa78c1777780cc24c65db173fa215064a981c3dfd49"; # registry hash
          sha256 = "sha256-H+n9iwjEclNRkodYelgX1yhPPV9LyrDWqiPrCupSors="; # nix store hash
          finalImageTag = "44";
          arch = "amd64";
        }).overrideAttrs
          {
