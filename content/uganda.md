...
date: 2022-03-02
tags: vim
description: Vim is Charityware.
---
...
Vim is Charityware. You can use and copy it as much as you like, but you are encouraged to make a donation for needy children in Uganda. Please see [Kibaale Children's Centre](#kibaale-childrens-centre) below or visit the ICCF web site, available at these URLs:
...
The Open Publication License applies to the Vim documentation.
...
- If you distribute a modified version of Vim, you can include your name and contact information with the `--with-modified-by` configure argument or the `MODIFIED_BY` define.
...
Check the ICCF web site for the latest information! See [Summary](#summary) for the URL.
